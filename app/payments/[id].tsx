...
import { formatIsoDateTime } from '@/services/format';
...
export default function PaymentDetailScreen() {
  ...
  return (
    <Screen>
      ...
      {isLoading ? (
        <LoadingState label="영수증을 불러오는 중입니다." />
      ) : notFound ? (
        ...
        errorMessage ? <ErrorBanner message={errorMessage} onRetry={() => void loadPayment()} /> : null
      ) : (
        <>
          ...
          <View style={styles.receiptCard}>
            ...
            <ReceiptRow
              ...
              value={formatIsoDateTime(payment.approved_at ?? payment.created_at)}
            />
